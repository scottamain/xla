...
# This runs markdownlint-cli with the specified files (via Docker).
# The file/directory/glob paths must be relative to the repo root.
# For example, to lint all docs:
#   bash tools/ci_build/docs_build/lint_markdown.sh "./**/*.md"
#
...
readonly XLA_ROOT_DIR="${SCRIPT_DIR}/../../.."
...
docker run -v $XLA_ROOT_DIR:/workdir \
